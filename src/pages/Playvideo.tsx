        ...
        <div className="lg:w-2/3">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-4">
              <Avatar>
                <AvatarImage src="/placeholder.svg?height=40&width=40" alt={video.channel} />
                <AvatarFallback>{video.channel[0]}</AvatarFallback>
              </Avatar>
              <div>
                <p className="font-semibold text-gray-200">{video.channel}</p>
          ...
          <div className="bg-gray-800 p-4 rounded-lg mb-8 shadow-lg">
            <p className="font-semibold mb-2 text-gray-400">{video.views} • {video.date}</p>
              ...
              <div key={comment.id} className="flex gap-4 mb-4">
                ...
                <div>
                  <p className="font-semibold text-gray-200">
                    {comment.user} <span className="font-normal text-sm text-gray-500">{comment.date}</span>
                  </p>
