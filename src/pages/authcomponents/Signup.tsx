...
export default function SignupPage() {
  ...
  return (
    ...
    <div className="container  mt-1 px-4 py-8 flex justify-center items-center max-h-[100vh]">
      <Card className="w-full  max-w-md lg:max-w-sm h-full flex flex-col justify-between">
        ...
        <CardFooter className="flex justify-center">
          <p className="text-sm text-muted-foreground">
            ...
            <button className="btn bg-black  text-white rounded-full p-2 mx-3 hover:bg-red-600">
                SignIn
            </button>
          </p>
        </CardFooter>
